...
if ($q !== '') {
    ...
    $sql = "
        ...
        WHERE sr.id = ? OR sr.service_name LIKE ? OR u.username LIKE ? OR u.email LIKE ?
...
<?php render_panel_sidebar('admin', 'search.php'); ?>
                ...
                <table class="table table-hover table-card-responsive">
                    ...
                    <?php foreach($rows as $r): ?>
                        <tr>
                            ...
                            <td data-label="Open"><a class="btn btn-sm btn-outline-primary" href="service_requests.php?q=<?php echo urlencode((string)$r['id']); ?>">Manage</a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
